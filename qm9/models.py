...
import sys
import os
sys.path.append(os.path.abspath("D:\qml\edm_key_files"))
import numpy as np
...
if __name__ == '__main__':
    ...
    dataset_info = get_dataset_info('qm9', True)
    dataset_info['n_nodes'] = {key: dataset_info['n_nodes'][key] for key in [1,2,]}
    dist_nodes = DistributionNodes(dataset_info['n_nodes'])
    print(dist_nodes.n_nodes)
    print(dist_nodes.prob)
    print(dist_nodes.sample(10))